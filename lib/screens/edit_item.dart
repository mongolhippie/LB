...
class FormEditItemPage extends StatefulWidget {
  FormEditItemPage({Key key, this.id}) : super(key: key);
  final String id;

  @override
  _FormEditItemPageState createState() => _FormEditItemPageState();
}

class _FormEditItemPageState extends State<FormEditItemPage> {
  ...
  void initState() {
    ...
    _unitsAvailable = item.getQuantity();
    image = item.getPhoto();
  }
...
//                            width: MediaQuery.of(context).size.width / 3.6,
                              radioButtonValue: (value) => _unit =
                                  EnumToString.fromString(units.values, value),
                              horizontal: false,
                            ...
                            Row(
                              children: <Widget>[
                                Expanded(
                                  child: TextFormField(
                                    initialValue: _unitsAvailable.toString(),
                                    keyboardType:
                                        TextInputType.numberWithOptions(
                                            decimal: true),
                                    inputFormatters: [
                                    ...
                                    onSaved: (value) =>
                                        _unitsAvailable = double.parse(value),
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return 'Please enter some text';
                                      }
